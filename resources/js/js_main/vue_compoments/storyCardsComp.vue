...
<template>
    ...
    <div   @click.stop="diretionToURL('/ueber-uns/story/talagrad')"  class="storyCardsWrapper">
        ...
        <div class="storyCards">
            <label>Donnerfels</label>
            <div  @click.stop="diretionToURL('/ueber-uns/story/donnerfels')" class="storyCard">
                <img :src="logoDonnerfels" alt="logoDonnerfels">
            </div>
        </div>

        <div  @click.stop="diretionToURL('/ueber-uns/story/eckland')"  class="storyCards">
            <label>Eckland</label>
            <div class="storyCard">
